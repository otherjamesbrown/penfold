...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  --quick          Quick health check only (gateway health endpoints)"
    echo "  --gateway        Gateway-specific tests (health + services + logs)"
    echo "  --worker         Worker-specific tests (health + ML services)"
