...
**First, load:** `cxp knowledge show mycroft-dev-index` then `cxp knowledge show mycroft-agent-cli-dev`
...
2. `cxp knowledge show mycroft-agent-cli-dev` — your domain context
