...
**First, load:** `cxp knowledge show mycroft-dev-index` then `cxp knowledge show mycroft-agent-gmail-dev`
...
2. `cxp knowledge show mycroft-agent-gmail-dev` — your domain context
