...
// Matches checks whether a field value satisfies this match condition.
// Exported so other packages (e.g. tenant context provider) can reuse the matching logic.
