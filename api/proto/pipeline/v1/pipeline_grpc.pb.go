...
func (c *pipelineServiceClient) RemoveTenantContextCondition(ctx context.Context, in *RemoveTenantContextConditionRequest, opts ...grpc.CallOption) (*RemoveTenantContextConditionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveTenantContextConditionResponse)
	err := c.cc.Invoke(ctx, PipelineService_RemoveTenantContextCondition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PipelineService_RemoveTenantContextCondition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveTenantContextConditionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PipelineServiceServer).RemoveTenantContextCondition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PipelineService_RemoveTenantContextCondition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PipelineServiceServer).RemoveTenantContextCondition(ctx, req.(*RemoveTenantContextConditionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
